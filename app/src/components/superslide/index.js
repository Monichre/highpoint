...
OSREC.superslide = function(p) {
  ...
  me.p.allowDrag =
    typeof me.p.allowDrag === "undefined" ? true : me.p.allowDrag;
  me.p.slideContent =
    typeof me.p.slideContent === "undefined" ? true : me.p.slideContent;
  me.p.allowContentInteraction =
    typeof me.p.allowContentInteraction === "undefined"
      ? false
      : me.p.allowContentInteraction;
  me.p.closeOnBlur =
    typeof me.p.closeOnBlur === "undefined" ? false : me.p.closeOnBlur;
  ...
  me.p.beforeOpen =
    typeof me.p.beforeOpen === "function" ? me.p.beforeOpen : function() {};
  me.p.onOpen = typeof me.p.onOpen === "function" ? me.p.onOpen : function() {};
  me.p.beforeClose =
    typeof me.p.beforeClose === "function" ? me.p.beforeClose : function() {};
  me.p.onClose =
    typeof me.p.onClose === "function" ? me.p.onClose : function() {};
  ...
  switch (me.p.animation) {
    case "slideLeft": {
      me.p.slider.style.cssText = `position: fixed; overflow-y: auto; -webkit-overflow-scrolling: touch; width: ${
        me.p.width
      }; height: 100%; top: 0px; left: -${me.p.width};`;
    ...
    case "slideTop": {
      me.p.slider.style.cssText = `position: fixed; overflow-x: auto; -webkit-overflow-scrolling: touch; width: 100%; height: ${
        me.p.height
      }; top: -${me.p.height}; left: 0;`;
      me.p.slider.style.transition = `${me.p.duration}s`;
  ...
  var promise = new Promise(function(resolve, reject) {
    var onOpenTransitionEnd = function(e) {
      ...
      if (target == me.p.slider) {
        me.p.onOpen();
        me.p.isOpen = true;
        me.p.slider.removeEventListener(
          me.p.cssTransitionEndEvent,
          onOpenTransitionEnd
        );
        me.p.content.addEventListener(
          "touchstart",
          me.p.contentTouchStartFunction
        );
  ...
  var promise = new Promise(function(resolve, reject) {
    var onCloseTransitionEnd = function(e) {
      ...
      if (target == me.p.slider) {
        ...
        me.p.content.removeEventListener(
          "touchstart",
          me.p.contentTouchStartFunction
        );
...
export default OSREC.superslide;
