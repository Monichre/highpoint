...
export const componentRoutes = routeWithComponents.map((route, i) => (
  <Route
    exact={route.exact}
    key={"route-" + i}
    path={route.path}
...
export const leftNavRoutes = routeWithComponents.map((route, i) => (
  <Route
    exact={route.exact}
    key={"route-" + i}
    path={route.path}
...
export const rightNavRoutes = routeWithComponents.map((route, i) => (
  <Route
    exact={route.exact}
    key={"route-" + i}
    path={route.path}
