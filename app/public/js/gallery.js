...
//   window.imagesLoaded(document.querySelectorAll(['.fullview__item', '.grid__item-bg']), { background: true }, () =>
...
//   )
  ...
  class Grid {
    constructor() {
      ...
      // the more/back box
      this.DOM.moreCtrl = this.DOM.grid.querySelector('.grid__item--more .grid__toggle');
        // this.DOM.moreCtrl = this.DOM.grid.querySelector('.grid__item--more')
    //   this.DOM.moreCtrl = document.querySelector('.grid__toggle')
    ...
    initEvents() {
      ...
      console.log(this.DOM.moreCtrl)
      this.DOM.moreCtrl.addEventListener('click', () => {
          console.log(!this.isGridHidden)
    ...
    toggleRevealer(action, dir) {
      ...
      return new Promise((resolve, reject) => {
        ...
        if (action === 'show') {
          _this.DOM.revealer.style.backgroundColor = _this.movable[_this.current].DOM.el.dataset.revealerColor
        }
        // animate the revealer up or down.
        TweenMax.to(_this.DOM.revealer, action === 'show' ? 1 : 1, {
